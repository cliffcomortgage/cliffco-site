...
export const PRODUCTS: readonly Product[] = [
  ...
  { slug: "asset-utilization-mortgage", name: "Asset Utilization Mortgage", shortName: "Asset Utilization", oneLiner: "Retirees and high-net-worth borrowers qualify using liquid assets as income — no W-2 or pay stub required.", directAnswer: "An asset utilization mortgage (also called asset depletion) calculates qualifying income by dividing verified liquid assets across a set term, letting retirees, pre-retirees, and high-net-worth borrowers qualify without W-2s or regular income. Cliffco's asset utilization programs accept checking, savings, brokerage, and retirement accounts as the basis for qualifying income.", loanType: "Non-QM Asset Utilization", isPriority: false, category: "Non-QM" },
  // Supporting products
