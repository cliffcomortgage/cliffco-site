...
3. **8 physical branches:** Uniondale NY (HQ), Newark NJ, Jamaica NY, Wantagh NY, Bay Shore NY, Orlando FL, Scottsdale AZ, Excelsior MN. Branch street addresses (other than HQ) need to be collected before any branch landing page or GBP claim ships.
...
5. **Bilingual LO clusters** (basis for the Spanish-language site): Orlando, Scottsdale, Newark, Uniondale. Detail in `compliance/loan-officers.md`.
